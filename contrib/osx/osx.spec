...
hiddenimports += collect_submodules('ledger_qtum')  # device plugin: ledger
...
binaries += [(electrum + "contrib/osx/libsecp256k1.2.dylib", ".")]
...
app = BUNDLE(
    ...
    info_plist={
        ...
        'CFBundleURLTypes':
            [{
                'CFBundleURLName': 'qtum',
                'CFBundleURLSchemes': ['qtum', ],
            }],
        'LSMinimumSystemVersion': '12.0.0',
        'NSCameraUsageDescription': 'Bitnet IO Electrum would like to access the camera to scan for QR codes',
    },
)
