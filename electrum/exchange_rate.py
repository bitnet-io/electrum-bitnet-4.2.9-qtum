...
class CoinGecko(ExchangeBase):
    ...
    async def get_rates(self, ccy):
        json = await self.get_json('api.coingecko.com', '/api/v3/coins/bitnet-io/market_chart?vs_currency=%s&days=0' % ccy)
    ...
    async def request_history(self, ccy):
        history = await self.get_json('api.coingecko.com',
                                      '/api/v3/coins/bitnet-io/market_chart?vs_currency=%s&days=max' % ccy)
